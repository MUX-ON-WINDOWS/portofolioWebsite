<template>
    ...
    <div class="container_row">
      ...
      <div class="container_content_uitleg1">
        <div class="content_container_margin">
            <h3>Reflectie:</h3>
              Mijn reflectie is hoe meer versies je maakt hoe meer mogelijke heden hebt tot een goed eind ontwerp.
              De website designs heb ik gemaakt in Figma en de kaarten heb ik gemaakt in illustrator.
              Zelf vind ik dat het website design van Kathleen niet echt heel goed uit de verf is gekomen.
              De kaarten die ik heb gemaakt zijn wel zeer goed gelukt.
  ...
  <div class="container_row">
    <div class="container_content_uitleg2">
      <div class="content_container_margin">
        ...
        Bv bij de nachtegaal Vue.js project setup ging het al fout, doordat ik geen routers had geven.
        Hierdoor kon ik geen pagina’s linken. Het maken van nieuwe dingen in JS zelf ging zeer goed.
        <h3>Bewijs:</h3>
        <ul>
  ...
  <div class="container_row">
    <div class="container_content_uitleg2">
      <div class="content_container_margin">
        <h3>Reflectie:</h3>
          Ik ben tot conclusie gekomen dat het best lastig kan zijn om sommige dingen te onderzoeken waar niet al te
