    ...
    data() {
      return {
        slides: [
            ...
            {imageUrl : "src/assets/goalKeeperLogo_MaxV2.png", contentName: "KeepersWebShop", sprint: "Sprint 3", linkPage: "/KeeperSprint3", backgroundColor: "#D3AE87", width: "300px", color: "black"},
